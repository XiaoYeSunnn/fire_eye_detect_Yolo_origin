...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    video_path      = "D://fire hole/fire hole video/20201112/video_20201112_094510.mp4"
    video_save_path = ""
    video_fps       = 25.0
    #----------------------------------------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                r_image.show()
                save_dir = 'C:/Users/29572/Desktop/fire hole/YOLO'
                # Check if directory exists, if not, create it
                if not os.path.exists(save_dir):
                    os.makedirs(save_dir)
                # Define the path for saving the image
                save_path = os.path.join(save_dir, os.path.basename(img))
                # Save the image
